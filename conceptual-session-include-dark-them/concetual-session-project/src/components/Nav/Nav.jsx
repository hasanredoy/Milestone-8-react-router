...
const Nav = () => {
  ...
  useEffect(() => {
    ...
    const themLS = localStorage.getItem('them')
    document.querySelector('html').setAttribute('data-them', themLS)
  }, [them])
  const handleThem = (e) => {
    if (e.target.checked) {
      setThem('synthwave')
  ...
  return (
    ...
    <div className="navbar bg-base-200 shadow-lg my-0 container mx-auto rounded-s-xl ">
      ...
      <div className="flex-none gap-4">
        <ul className="menu-horizontal px-1 gap-5 font-bold text-xl">
          <li><NavLink to="/">Home</NavLink></li>
          <li><NavLink to="/blogs">Blogs</NavLink></li>
          <li><NavLink to="/bookmarks">Bookmarks</NavLink></li>
        </ul>
        <label onChange={handleThem} className="swap swap-rotate">
